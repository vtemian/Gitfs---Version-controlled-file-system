...
Gitfs implements a transparent concurrency models and manipulates the content directly, without using another layer. In this way, the user's change will be versioned automatically, without user intervention. Beside that, using a multi-layered cache system, Gitfs will not add any performance overhead for the final user.
\end{abstract}
